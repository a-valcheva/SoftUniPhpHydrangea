  ...
  if ($_FILES["file"]["error"] > 0) {
    ...
    if (file_exists("upload/" . $_FILES["file"]["name"])) {
      ...
      //echo "Stored in: " . "upload/" . $_FILES["file"]["name"];
		...
		$sql="CREATE TABLE {$imgName}(id INT,name CHAR(100), comment CHAR(100))";
	  ...
	  if(isset($_POST['submit'])){
		...
		$sql="CREATE TABLE {$pageName}(id INT,name CHAR(100))";
		...
		mysql_select_db("my_db");
			$insert = mysql_query("INSERT INTO {$pageName} (name) VALUES ('$nameP')");
			} else {
